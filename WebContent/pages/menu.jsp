    ...
    <div class="container">
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="VisitanteServlet?acao=listartodos">Cadastrar visitante</a></li>
          <li><a href="#services">Lista de Ramais</a></li>
          <li><a href="LoginServlet?acao=listartodos">Cadastrar Login</a></li>
    ...
    <div class="container d-flex h-100">
      <div class="row justify-content-center align-self-center">
        <div class="col-md-6 intro-info order-md-first order-last">
          ...
          <h2>Sistema de Portaria <br> <span>FCP</span></h2>
